...
namespace BlackJack
{
    class Program // this is our main class called Program and this is the entrance point of a console app
    {
        ...
        {
            string connectionString = @"Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=BlackJackGame;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False"; // getting connection string like above
